            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {profileOpen && (
                <div className="absolute right-0 mt-2 w-56 rounded-xl bg-dark-900 border border-dark-700 shadow-2xl py-2 animate-in fade-in slide-in-from-top-2 duration-200">
                  ...
                  {user?.isAdmin && (
                    <>
                      <Link to="/admin/theme" onClick={() => setProfileOpen(false)} className="flex items-center gap-2 px-4 py-2.5 text-sm text-primary-400 hover:text-primary-300 hover:bg-dark-800 transition-colors font-medium">
                        <Palette className="h-4 w-4 text-primary-400" /> Farbschema anpassen
                      </Link>
