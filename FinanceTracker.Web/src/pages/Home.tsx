...
const Home: React.FC = () => {
  return (
    <>
      <Navbar />
      <main className="pt-24 pb-16 min-h-screen bg-dark-950 text-dark-100 font-sans">
      {/* Hero Section */}
      <section className="bg-dark-950">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
          ...
          <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <Link to="/register" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:ring-primary-900 transition-colors">
              Jetzt starten
